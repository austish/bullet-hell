...
void Player::shootBullet(int mouseX, int mouseY) {
    const float BULLET_SPEED = 8.0f;  // Define player's bullet speed

    // Calculate the direction from player to the cursor
...
// To reset player after they die and new game is started
